...
parser.add_argument('--data_path', type=str, default='/home/yangho/dev/dataset/phase1_dataset_v2/train')
...
parser.add_argument('--l_coord', type=int, default=1)
parser.add_argument('--l_noobj', type=float, default=0.2)
parser.add_argument('--num_gpus', type=int, default=1)

parser.add_argument('--sz_embedding', type=int, default=1024)
parser.add_argument('--sigma', type=float, default=0.07)
# flag
parser.add_argument('--use_augmentation', type=lambda x: (str(x).lower() == 'true'), default=False)
